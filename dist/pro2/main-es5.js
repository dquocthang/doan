...
var ApiService = /** @class */ (function () {
    ...
    // }
    ApiService.prototype.onInsert = function (req) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.login(this.loginForm.value).subscribe(function (res) {
            ...
            console.log(res);
            _this.router.navigateByUrl('/reservation');
        });
    };
...
var ReservationComponent = /** @class */ (function () {
    function ReservationComponent(apiService, authService, router) {
    ...
    ReservationComponent.prototype.onValueChange = function (value) {
        this.data = value;
    };
    ...
    ReservationComponent.prototype.selection = function () {
    ...
    ReservationComponent.prototype.onSubmit = function () {
        if (this.booking.valid) {
            ...
            // this.booking.reset();
            this.apiService.onInsert(this.booking.value).subscribe(function (res) {
                console.log(res);
                // alert(stringify(res));
            });
            this.booking.reset();
    ...
    ReservationComponent.prototype.createFormControls = function () {
    ...
    ReservationComponent.prototype.createForm = function () {
    ...
    ReservationComponent.prototype.logout = function () {
        this.authService.logout();
        this.router.navigateByUrl('/login');
    };
    ReservationComponent.prototype.ngAfterViewInit = function () {
    };
